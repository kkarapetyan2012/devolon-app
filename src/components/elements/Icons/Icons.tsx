...
import { createCSSClass } from 'src/utils/jsxHelpers';
...
export const IconBurger: FC<IconProps> = ({ className, color, width = 24, height = 24, onClick }) => (
  <SvgIcon viewBox="0 0 1024 1024" width={width} height={height} className={className} onClick={onClick}>
    <path d="M896 341.333h-768v85.333h768v-85.333z" fill={color}></path>
    <path d="M896 554.667h-768v85.333h768v-85.333z" fill={color}></path>
    <path d="M896 767.993h-768v85.333h768v-85.333z" fill={color}></path>
  </SvgIcon>
);